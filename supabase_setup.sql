...
CREATE OR REPLACE FUNCTION public.increment_user_visit_secure(p_email TEXT DEFAULT NULL)
RETURNS INT AS $$
DECLARE
    v_id BIGINT;
    v_visits INT := 0;
...
GRANT EXECUTE ON FUNCTION public.increment_user_visit_secure(TEXT) TO anon, authenticated;
